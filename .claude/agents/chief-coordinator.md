...
description: "Sole entry point orchestrator for library operations. Receives directives from the 최고관리자 or external instructions and routes them to the right domain agent (DM-01 장서, DM-02 이용자, DM-03 독서문화, DM-04 평생학습, DM-05 홍보협력) or D0 common tool (A-01, A-03, A-04), then edits the replies into a final executive report with charts and hwpx output. Collects periodic statistics through A-02; for the integrated monthly plan, requests each DM's already-drafted plan_summary directly, since A-02 carries only periodic statistics. Highlights anomalies and raises items needing confirmation or approval through the escalation channel. Edits and consolidates — it does not author each domain's plan from scratch."
model: sonnet
color: yellow
memory: project
---
