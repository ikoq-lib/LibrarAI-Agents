...
description: "Use this agent when managing the operational phase of lifelong learning programs at a Korean public library — specifically for recording session attendance, calculating attendance rates, logging special incidents (휴강, 보강, 강사 변경 등), generating monthly instructor fee payment statements (강사비 지급 내역서), and passing season-end operational data to the DM-04 reporting agent. This agent is activated after E-03 (모집 에이전트) hands off the enrolled student list and program schedule.\\n\\n<example>\\nContext: E-03 has just completed student recruitment and is passing the enrolled roster and schedule to E-04.\\nuser: \"캘리그라피 강좌 수강생 명단과 일정을 인계받았습니다. 3월 7일부터 매주 금요일 10회차, 수강생 14명입니다.\"\\nassistant: \"E-03으로부터 수강생 명단과 일정을 수신했습니다. 출결 관리 대장 Excel 서식을 자동 생성하겠습니다.\"\\n<commentary>\\nSince E-03 handoff data has been received, use the Agent tool to launch the lifelong-learning-operation-log agent to generate the attendance roster Excel file and initialize the SQLite tables.\\n</commentary>\\nassistant: \"운영일지 에이전트를 실행하여 출결 관리 대장을 생성합니다.\"\\n</example>\\n\\n<example>\\nContext: A librarian has just finished running the 3rd session of a calligraphy class and needs to record attendance.\\nuser: \"캘리그라피 3회차 출결 입력합니다. 진행일 2026-03-21, 출석 12명, 결석 2명(이○○, 박○○), 특이사항: 강사 변경(대체 강사 홍○○)\"\\nassistant: \"3회차 출결 현황을 입력하겠습니다. 대체 강사 정보도 함께 기록합니다.\"\\n<commentary>\\nThe librarian is submitting session attendance data. Use the Agent tool to launch the lifelong-learning-operation-log agent to record attendance in SQLite, update the Excel file, and log the instructor substitution as a special remark.\\n</commentary>\\nassistant: \"운영일지 에이전트를 실행하여 3회차 출결을 기록합니다.\"\\n</example>\\n\\n<example>\\nContext: It is the end of March and the librarian needs the monthly instructor fee statement.\\nuser: \"3월 강사비 지급 내역서 초안 만들어주세요.\"\\nassistant: \"3월에 진행된 회차를 확인하여 강사비 지급 내역서 hwpx 초안을 생성하겠습니다.\"\\n<commentary>\\nThe librarian is requesting the monthly instructor fee statement. Use the Agent tool to launch the lifelong-learning-operation-log agent to calculate fees, call A-01 for hwpx generation, and notify A-03 for budget recording.\\n</commentary>\\nassistant: \"운영일지 에이전트를 실행하여 3월 강사비 지급 내역서를 생성합니다.\"\\n</example>\\n\\n<example>\\nContext: The spring season has ended and operational data needs to be passed to DM-04.\\nuser: \"상반기 강좌 운영이 모두 종료되었습니다. DM-04에 운영 실적을 전달해주세요.\"\\nassistant: \"시즌 종료를 확인했습니다. DM-04 결과보고 에이전트에 운영 실적 데이터를 전달하겠습니다.\"\\n<commentary>\\nThe season has ended and DM-04 needs the handoff data. Use the Agent tool to launch the lifelong-learning-operation-log agent to compile and transmit the season summary JSON to DM-04.\\n</commentary>\\nassistant: \"운영일지 에이전트를 실행하여 DM-04에 운영 실적을 인계합니다.\"\\n</example>"
model: sonnet
color: blue
memory: project
---
