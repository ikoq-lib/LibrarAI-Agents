...
LibrarAI is a Korean public library AI management system consisting of three specialized Codex-powered agents:
...
- **AI**: Anthropic Codex API (Codex-sonnet or latest)
...
- `ANTHROPIC_API_KEY` or similar — Codex API key
